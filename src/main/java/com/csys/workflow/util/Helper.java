    ...
    public static String getMimeType(String extension) {
        ...
        switch (extension) {
            ...
            case "docx":
                ...
                break;
            case "dotx":
                mime = "data:application/vnd.openxmlformats-officedocument.wordprocessingml.workflow;base64,";
                break;
            case "docm":
                mime = "data:application/vnd.ms-word.document.macroEnabled.12;base64,";
                break;
            case "dotm":
                mime = "data:application/vnd.ms-word.workflow.macroEnabled.12;base64,";
                break;
            ...
            case "xlsx":
                ...
                break;
            case "xltx":
                mime = "data:application/vnd.openxmlformats-officedocument.spreadsheetml.workflow;base64,";
                break;
            case "xlsm":
                mime = "data:application/vnd.ms-excel.sheet.macroEnabled.12;base64,";
                break;
            case "xltm":
                mime = "data:application/vnd.ms-excel.workflow.macroEnabled.12;base64,";
                break;
            case "xlam":
            ...
            case "pptx":
                ...
                break;
            case "potx":
                mime = "data:application/vnd.openxmlformats-officedocument.presentationml.workflow;base64,";
                break;
            case "ppsx":
            ...
            case "pptm":
                ...
                break;
            case "potm":
                mime = "data:application/vnd.ms-powerpoint.workflow.macroEnabled.12;base64,";
                break;
            case "ppsm":
